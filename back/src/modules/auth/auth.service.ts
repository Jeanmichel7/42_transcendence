...
export class AuthService {
  ...
  private async OAuthGetToken(
    ...
    const redirect_uris = [
      ...
      'http://193.203.191.28/oauthredirection',
      'https://193.203.191.28/oauthredirection',
      'http://www.transcendence42.fr/oauthredirection',
      'http://transcendence42.fr/oauthredirection',
      'https://www.transcendence42.fr/oauthredirection',
      'https://transcendance42.fr/oauthredirection',
    ];
    let error: any = null;
