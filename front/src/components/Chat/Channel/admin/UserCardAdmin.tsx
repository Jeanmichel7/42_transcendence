...
const AdminUserCard: React.FC<UserCardProps> = ({ user, room }) => {
  ...
  const handleMuteUser = async (
    ...
    e.preventDefault();
    if (isOwner || isAdmin)
      return dispatch(setErrorSnackbar("You can't mute an admin or owner"));
  ...
  const handleUnMuteUser = async (
    ...
    e.preventDefault();
    if (isOwner || isAdmin)
      return dispatch(setErrorSnackbar("You can't unmute an admin or owner"));
  ...
  const handleAddAdmin = async (
    ...
    if (isBanned)
      return dispatch(setErrorSnackbar("You can't add admin to a banned user"));
    if (isOwner)
      return dispatch(setErrorSnackbar("You can't add admin to the owner"));
  ...
  const handleRemoveAdmin = async (
    ...
    if (isOwner)
      return dispatch(setErrorSnackbar("You can't remove admin to the owner"));
